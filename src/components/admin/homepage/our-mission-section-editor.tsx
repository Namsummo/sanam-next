...
export function OurMissionSectionEditor() {
  ...
  function renderImageUploadPreview(src: string) {
    ...
    return (
      <div className="overflow-hidden rounded-[12px] border border-border bg-muted/20 p-2">
        <img src={src} alt="Xem trước" className="mx-auto max-h-40 max-w-full object-contain" />
      </div>
    );
  }
