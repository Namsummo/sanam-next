...
export function AdminClergyFormModal({
  ...
  return (
    <AdminFormDialog
      ...
      title={editingId ? "Chỉnh sửa chức vụ / nhiệm kỳ" : "Thêm vào Ban Hành Giáo / Quý Cha"}
    ...
    >
      ...
      >
        ...
        <AdminPersonSelector
          value={personIdValue}
          onChange={(pId) => form.setValue("personId", pId, { shouldValidate: true, shouldDirty: true })}
          label="Chọn hồ sơ giáo dân"
          required
