...
export function NewsHtmlContent({ html, className }: NewsHtmlContentProps) {
  return (
    <div
      className={cn(
        "news-entry w-full break-words border-b border-border pb-8 font-sans text-lg leading-relaxed text-foreground",
        ...
        "[&_img]:block [&_img]:mx-auto [&_img]:h-auto [&_img]:w-auto [&_img]:max-w-full [&_img]:rounded-[12px]",
