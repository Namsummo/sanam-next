...
export function NewsHtmlContent({ html, className }: NewsHtmlContentProps) {
  return (
    <div
      className={cn(
        "news-entry w-full overflow-x-hidden border-b border-border pb-8 font-sans text-lg leading-relaxed text-foreground [overflow-wrap:break-word] [word-break:normal]",
